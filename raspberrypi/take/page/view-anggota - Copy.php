...
<div id="reg" class="full-form colorwh">
		...
		$no++;
		echo "<tr>
			  <td class='td-data'><a href='view-riwayat.php?id=$hasil[id]'>$hasil[id]</td>
			  ...
			  <td class='td-data'><a href='form-edit-anggota.php?id=$hasil[id]'><i class='fa fa-gear'></i></a></td>
			  <td class='td-data'><a href='../php/action/act_hapus_anggota.php?id=$hasil[id]' onclick='return confirm(\"Anda yakin ingin menghapus data ini ?\")'><i class='fa fa-remove'></i></a></td>
			  </tr>";
		}
		?>
		</table>
